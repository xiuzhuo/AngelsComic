...
public class GoogleCloudStorageAPI {
     ...
     */
    private static final String APPLICATION_NAME = "comic-poster";
    private static final String BUCKET_NAME = "979610159706-g711p39hii1to1u9ailkp7hoq8mi69s3.apps.googleusercontent.com";
    ...
    private static Credential authorize() throws Exception {
        ...
        try {
            File file = new File(GoogleCloudStorageAPI.class.getClassLoader().getResource(CLIENT_SECRET_FILENAME).getPath());
            System.out.println("file=" + file + " exist " + file.exists());
            System.out.println(IOUtils.inputStreamToString(GoogleCloudStorageAPI.class.getResourceAsStream("/" + CLIENT_SECRET_FILENAME)));

            clientSecrets = GoogleClientSecrets.load(JSON_FACTORY,
                    new InputStreamReader(GoogleCloudStorageAPI.class.getResourceAsStream("/" + CLIENT_SECRET_FILENAME)));
//            GoogleAuthorizationCodeFlow flow = new GoogleAuthorizationCodeFlow.Builder(
//                    httpTransport, JSON_FACTORY, clientSecrets,
//                    Collections.singleton(StorageScopes.CLOUD_PLATFORM)).setDataStoreFactory(dataStoreFactory)
//                    .build();
